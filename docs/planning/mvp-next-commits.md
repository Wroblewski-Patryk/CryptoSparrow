...
## NOW
- [ ] `BOPS-19 feat(web-dashboard): polish global control-center cards and CTA hierarchy to complement Bots operations center`

## NEXT
- [ ] `BOPS-20 feat(web-dashboard): improve control-center quick-actions and status grouping for first-visit operator clarity`
## BLOCKED
