...
- [ ] `SEC-01 chore(deps-web): upgrade next to latest patched 15.x line and align eslint-config-next`
- [ ] `SEC-02 chore(deps-web): upgrade axios to patched version and run web regression/typecheck`
